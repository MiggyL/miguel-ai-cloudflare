    ...
    <div className="relative bg-black rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="absolute bottom-3 left-3 z-[6] flex items-center gap-1.5">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Chat with Miguel on WhatsApp"
          className="inline-flex items-center justify-center w-[26px] h-[22px] bg-white/10 backdrop-blur-sm border border-white/15 rounded-md hover:bg-white/20 transition-all cursor-pointer opacity-50 hover:opacity-100"
        >
